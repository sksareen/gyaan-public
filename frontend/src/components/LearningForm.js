        ...
        <ThemeProvider theme={theme}>
            <Container maxWidth="md" sx={{ 
                ...
                <Box sx={{ mt: 4, mb: 4, minWidth: '320px', width: '100%' }}>
                    <img src="logo.png" alt="logo" style={{ borderRadius: '50%', height: '140px', width: '140px', marginLeft: 'auto', marginRight: 'auto', display: 'block', margin: '0 auto', marginBottom: '2rem', boxShadow: '2px 0px 7px -3px #00000070' }}/>
